...
export function dbFinancialsToFinancialYears(financials: DBFinancialYear[]): FinancialYear[] {
  ...
  for (const fy of financials) {
    ...
    years.push({
      ...
      fcf,
      fcfGrowth: null,
      depreciationAmortization: has('depreciation_amortization') ? get('depreciation_amortization') : undefined,
      capex: has('capital_expenditures') ? get('capital_expenditures') : undefined,
      currentAssets: has('current_assets') ? get('current_assets') : undefined,
      currentLiabilities: has('current_liabilities') ? get('current_liabilities') : undefined,
